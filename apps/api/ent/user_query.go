...
func (_q *UserQuery) QueryPricing() *PricingQuery {
...
func (_q *UserQuery) WithPricing(opts ...func(*PricingQuery)) *UserQuery {
	query := (&PricingClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withPricing; query != nil {
		if err := _q.loadPricing(ctx, query, nodes, nil,
			func(n *User, e *Pricing) { n.Edges.Pricing = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadPricing(ctx context.Context, query *PricingQuery, nodes []*User, init func(*User), assign func(*User, *Pricing)) error {
